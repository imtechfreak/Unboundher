                            ...
                            <div class="modal fade" id="myModal02" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
                                <div class="modal-dialog delete">
                                    <div class="modal-content">
                                        <div class="modal-header">
                                            <button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>
                                            <h4 class="modal-title" id="myModalLabel">Slider Settings</h4>
                                        </div>
                                        <div class="modal-body deletebody">
                                            <div>
                                                    ...
                                                    <div class="row">
                                                        <div class="col-md-6">
                                                            <div class="form-group">
                                                                <label>Slide Show Time</label>
                                                                <input type="time" name="time" class="form-control" placeholder="Enter the time in seconds">
                                                            </div>
                                                        </div>
                                                        <div class="col-md-6">
                                                            <div class="form-group">
                                                                <label>No of slides.</label>
                                                                <input type="text" name="slides" class="form-control" placeholder="Enter the number of slides to display">

                                                            </div>
                                                        </div>
                                                    </div>
                                                    <div class="modal-footer">
                                                        <!--<button type="button" class="btn btn-default" data-dismiss="modal">Close</button-->                                                        <input type="submit" name="submit" value="save" class="btn btn-primary">
                                                    </div>
                                                </form>
                                            </div>
                                        </div>
                ...
                <div class="row">
                    ...
                    <div class="col-lg-3 col-md-3">
                        ...
                        <!-- Button trigger modal -->
                            ...
                            <button class="btn btn-primary btn-lg" data-toggle="modal" data-target="#myModal02">
                                Settings
                            </button>
                            <!-- Modal -->
                            <div class="modal fade" id="myModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
                                <div class="modal-dialog blogmodal">
                                    <div class="modal-content">
                                        <div class="modal-header">
                                            <button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>
                                            <h4 class="modal-title" id="myModalLabel">Add new story for slider</h4>
                                        </div>
                                        <div class="modal-body">
                                            <div>
                                                <form method="post" action="" enctype="multipart/form-data">
                                                    <div class="row">
                                                        <div class="col-md-6">
                                                            <div class="form-group">
                                                                ...
                                                                <input type="text" name="name" class="form-control" placeholder="Enter the name of person whose story it is">
                                                            </div>
                                                        </div>
                                                        <div class="col-md-6">
                                                            <div class="form-group">
                                                    ...
                                                    <div>
                                                        <div class="container title">
                                                            <div class="row">
                                                                <div col-md-12>
                                                                    <div class="form-group">
                                                                       <input class="form-control" name="title" placeholder="Enter title of the story">
                                                                    </div>
                                                                </div>
                                                            </div>
                                                        </div>
                                                    ...
                                                    <div class="form-group">
                                                        <label>Content</label>
                                                        <textarea class="form-control" rows="18" name="content" placeholder="Enter the content of slider"></textarea>
                                                    </div>
                                            <!--</form>-->
                                            </div>
                                        <!--
